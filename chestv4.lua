...
local MainChestGui = Instance.new("Frame")
local UICorner = Instance.new("UICorner")
local Chestimg = Instance.new("ImageLabel")
local UIAspectRatioConstraint = Instance.new("UIAspectRatioConstraint")
local UIStroke = Instance.new("UIStroke")
local NameMain = Instance.new("TextButton")
local Robloximg = Instance.new("ImageLabel")
local OnOff = Instance.new("Frame")
local Menu = Instance.new("Frame")
local bbname = Instance.new("TextButton")
...
Chest.Name = "Chest"
Chest.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
Chest.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

MainChestGui.Name = "MainChestGui"
MainChestGui.Parent = Chest
MainChestGui.BackgroundColor3 = Color3.fromRGB(27, 42, 53)
MainChestGui.BackgroundTransparency = 0.700
MainChestGui.BorderColor3 = Color3.fromRGB(0, 0, 0)
MainChestGui.BorderSizePixel = 0
MainChestGui.ClipsDescendants = true
MainChestGui.Position = UDim2.new(0, 199, 0, 163)
MainChestGui.Size = UDim2.new(0, 432, 0, 246)

UICorner.Parent = MainChestGui

Chestimg.Name = "Chestimg"
Chestimg.Parent = MainChestGui
Chestimg.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Chestimg.BackgroundTransparency = 1.000
Chestimg.BorderColor3 = Color3.fromRGB(0, 0, 0)
Chestimg.BorderSizePixel = 0
Chestimg.Position = UDim2.new(0, 227, 0, 34)
Chestimg.Size = UDim2.new(0, 238, 0, 228)
Chestimg.Image = "rbxassetid://17851124858"

UIAspectRatioConstraint.Parent = Chestimg
UIAspectRatioConstraint.AspectRatio = 1.044

UIStroke.Transparency = 0.8999999761581421
UIStroke.Parent = MainChestGui

NameMain.Name = "NameMain"
NameMain.Parent = MainChestGui
NameMain.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
NameMain.BackgroundTransparency = 1.000
NameMain.BorderColor3 = Color3.fromRGB(255, 255, 255)
NameMain.BorderSizePixel = 0
NameMain.Position = UDim2.new(0, 50, 0, 9)
NameMain.Size = UDim2.new(0, 200, 0, 19)
NameMain.Font = Enum.Font.Gotham
NameMain.Text = "X-Sea Chest V2"
NameMain.TextColor3 = Color3.fromRGB(255, 255, 255)
NameMain.TextScaled = true
NameMain.TextSize = 14.000
NameMain.TextStrokeColor3 = Color3.fromRGB(255, 255, 255)
NameMain.TextWrapped = true
NameMain.TextXAlignment = Enum.TextXAlignment.Left

Robloximg.Name = "Robloximg"
Robloximg.Parent = MainChestGui
Robloximg.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Robloximg.BackgroundTransparency = 1.000
Robloximg.BorderColor3 = Color3.fromRGB(0, 0, 0)
Robloximg.BorderSizePixel = 0
Robloximg.Position = UDim2.new(0, 13, 0, 3)
Robloximg.Size = UDim2.new(0, 30, 0, 30)
Robloximg.Image = "rbxassetid://17851124858"

OnOff.Name = "OnOff"
OnOff.Parent = MainChestGui
...
OnOff.Position = UDim2.new(0.493055552, 0, 0.785857677, 0)
OnOff.Size = UDim2.new(0, 205, 0, 48)

Menu.Name = "Menu"
Menu.Parent = MainChestGui
Menu.BackgroundColor3 = Color3.fromRGB(27, 42, 53)
Menu.BackgroundTransparency = 0.600
Menu.BorderColor3 = Color3.fromRGB(0, 0, 0)
Menu.BorderSizePixel = 0
Menu.Position = UDim2.new(0, 0, 0.773662508, 0)
Menu.Size = UDim2.new(0, 432, 0, 55)

bbname.Name = "bbname"
bbname.Parent = MainChestGui
bbname.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
bbname.BackgroundTransparency = 1.000
bbname.BorderColor3 = Color3.fromRGB(255, 255, 255)
bbname.BorderSizePixel = 0
bbname.Position = UDim2.new(0, 13, 0, 208)
bbname.Size = UDim2.new(0, 200, 0, 19)
bbname.Font = Enum.Font.Gotham
bbname.Text = "Auto Farm Chest"
bbname.TextColor3 = Color3.fromRGB(255, 255, 255)
bbname.TextScaled = true
bbname.TextSize = 14.000
bbname.TextStrokeColor3 = Color3.fromRGB(255, 255, 255)
bbname.TextWrapped = true
bbname.TextXAlignment = Enum.TextXAlignment.Left

total.Name = "total"
total.Parent = MainChestGui
...
total.Position = UDim2.new(0.0300925933, 0, 0.284552842, 0)
total.Size = UDim2.new(0, 231, 0, 16)
...
Earn.Position = UDim2.new(0.0300925933, 0, 0.402439028, 0)
Earn.Size = UDim2.new(0, 231, 0, 16)
Earn.Font = Enum.Font.Gotham
Earn.Text = "Earn Beli:"
...
Off.Position = UDim2.new(0, 373, 0, 207)
Off.Size = UDim2.new(0, 32, 0, 19)
Off.Font = Enum.Font.Gotham
Off.Text = "Off"
Off.TextColor3 = Color3.fromRGB(255, 255, 255)
Off.TextScaled = true
Off.TextSize = 14.000
Off.TextStrokeColor3 = Color3.fromRGB(255, 255, 255)
Off.TextWrapped = true
Off.TextXAlignment = Enum.TextXAlignment.Left

On.Name = "On"
On.Parent = MainChestGui
...
On.Position = UDim2.new(0, 330, 0, 207)
On.Size = UDim2.new(0, 30, 0, 19)
On.Font = Enum.Font.Gotham
On.Text = "On"
On.TextColor3 = Color3.fromRGB(255, 255, 255)
On.TextScaled = true
On.TextSize = 14.000
On.TextStrokeColor3 = Color3.fromRGB(255, 255, 255)
On.TextWrapped = true
On.TextXAlignment = Enum.TextXAlignment.Left

time.Name = "time"
time.Parent = MainChestGui
time.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
time.BackgroundTransparency = 1.000
time.BorderColor3 = Color3.fromRGB(0, 0, 0)
time.BorderSizePixel = 0
time.Position = UDim2.new(0.0300925933, 0, 0.520325184, 0)
time.Size = UDim2.new(0, 231, 0, 16)
...
local function TLSM_fake_script() -- MainChestGui.MoveMain 
	local script = Instance.new('LocalScript', MainChestGui)

	script.Parent.Draggable = true
	script.Parent.Active = true
end
coroutine.wrap(TLSM_fake_script)()
local function INZQHUG_fake_script() -- MainChestGui.AutoFarmScript 
	local script = Instance.new('LocalScript', MainChestGui)
	...
	--// Save Setting
	local foldername = "X-Sea Auto Chest"
...
coroutine.wrap(INZQHUG_fake_script)()
local function FWHIBWN_fake_script() -- Off.Off 
...
coroutine.wrap(FWHIBWN_fake_script)()
local function RRRCKEC_fake_script() -- On.On 
...
coroutine.wrap(RRRCKEC_fake_script)()
