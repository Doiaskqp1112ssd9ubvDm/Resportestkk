if game.PlaceId == 2753915549 then
    ...
    game.Players.LocalPlayer:Kick("Blade Ball? , BF")
end
--------------------------------------------------------------------------------------------------------	
	function CheckQuest() 
...
local Window = OrionLib:MakeWindow({Name = "X-Sea Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "Premium"})
...
local We = Window:MakeTab({
	Name = "Webhook",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})

local Fr = Window:MakeTab({
	Name = "Fruits",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})

local Ma = Window:MakeTab({
	Name = "Config Skill Mastery",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})
...
local Section = Tabs1:AddSection({
	Name = "Info Owner Hub"
})

Tabs1:AddLabel("Owner: ! SeaNahh")

Tabs1:AddLabel("Developer: ! Taixiu")
Tabs1:AddLabel("Version : Premium")
Tabs1:AddLabel("Release date: !!?")
Tabs1:AddLabel("Status : 🔴")
Tabs1:AddLabel("coming soon")

Tab1:AddParagraph("Hi X-Sea","Premium Version")
...
G:AddToggle({
 ...
 G:AddDropdown({
	Name = "Select Farm",
	Default = "Quest",
	Options = {"Quest", "Nearest","No Quest"},
	Callback = function(Value)
		FarmMode = Value
	end    
})
...
G:AddLabel("Boss Farm")   

G:AddDropdown({
	Name = "Select Boss Farm",
	Default = "Melee",
    Flag = "Select Boss",
    Save = true,
	Options = tableMon,
...
local AttackList = {"Super Fast", "Fast", "Normal", "Xsea"}
S:AddDropdown({
    ...
    function()
        while wait() do
            if _G.FastAttackDelay then
                ...
                elseif _G.FastAttackDelay == "Xsea" then
